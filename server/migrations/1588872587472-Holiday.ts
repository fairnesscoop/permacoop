...
export class Holiday1588872587472 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TYPE "holiday_status_enum" AS ENUM('pending', 'accepted', 'refused')`,
      undefined
    );
    await queryRunner.query(
      `CREATE TYPE "holiday_leavetype_enum" AS ENUM('paid', 'unpaid', 'special', 'medical')`,
      undefined
    );
    await queryRunner.query(
      `CREATE TABLE "holiday" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "holiday_status_enum" NOT NULL, "leaveType" "holiday_leavetype_enum" NOT NULL, "startDate" TIMESTAMP NOT NULL, "startsAllDay" boolean NOT NULL DEFAULT true, "endDate" TIMESTAMP NOT NULL, "endsAllDay" boolean NOT NULL DEFAULT true, "comment" character varying, "moderationComment" character varying, "moderateAt" TIMESTAMP, "moderatorId" uuid, "userId" uuid NOT NULL, CONSTRAINT "PK_3e7492c25f80418a7aad0aec053" PRIMARY KEY ("id"))`,
      undefined
    );
    await queryRunner.query(
      `ALTER TABLE "holiday" ADD CONSTRAINT "FK_ff5a3d7c5305ccd35561624c7e6" FOREIGN KEY ("moderatorId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined
    );
    await queryRunner.query(
      `ALTER TABLE "holiday" ADD CONSTRAINT "FK_87112d6e6d22a8d60a1fb6df4c8" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "holiday" DROP CONSTRAINT "FK_87112d6e6d22a8d60a1fb6df4c8"`,
      undefined
    );
    await queryRunner.query(
      `ALTER TABLE "holiday" DROP CONSTRAINT "FK_ff5a3d7c5305ccd35561624c7e6"`,
      undefined
    );
