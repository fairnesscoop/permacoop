...
export class Holiday1588772445183 implements MigrationInterface {
    name = 'Holiday1588772445183'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TYPE "holiday_status_enum" AS ENUM('waiting', 'accepted', 'refused')`, undefined);
