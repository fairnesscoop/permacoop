...
import { GetMealTicketCountPerMonthQueryHandler } from 'src/Application/HumanResource/MealTicket/Query/GetMealTicketCountPerMonthQueryHandler';
...
@Module({
  ...
  providers: [
    ...
    GetMealTicketCountPerMonthQueryHandler
  ]
})
