...
describe('GetLeaveRequestsQueryHandler', () => {
  ...
  it('testGetLeaveRequests', async () => {
    ...
    when(leaveRequestRepository.findLeaveRequests(1, null, null)).thenResolve([
    ...
    verify(leaveRequestRepository.findLeaveRequests(1, null, null)).once();
  });
  ...
  it('testGetLeaves', async () => {
    ...
    when(
      leaveRequestRepository.findLeaveRequests(1, Status.ACCEPTED, null)
  ...
  it('testGetLeavesWithLimit', async () => {
    const expectedResult = new Pagination<LeaveRequestView>(
      [
        new LeaveRequestView(
          'd54f15d6-1a1d-47e8-8672-9f46018f9960',
    ...
    when(leaveRequestRepository.findLeaveRequests(1, null, 1)).thenResolve([
      [instance(leave1)],
      1
    ]);
    ...
    verify(leaveRequestRepository.findLeaveRequests(1, null, 1)).once();
  });
});
